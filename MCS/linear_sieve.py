...
# Example usage for a computationally quick test
n_test = 50 
weights_std, ds = optimize_sieve_weights(n_test, use_multiplicity_correction=False)
weights_mod, ds = optimize_sieve_weights(n_test, use_multiplicity_correction=True)
